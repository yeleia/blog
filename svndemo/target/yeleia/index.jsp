        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<%=request.getContextPath()%>/addBlog" method="post">
                        标题：<input id="blogTitle" type="text" name="blogTitle"><br><Br>
                        <textarea <%--id="blogContent"--%>  style="height:450px;" id="container" name="blogContent" type="text/plain">
                        </textarea><br>
                       <h4>分类：<select  name="blogType"<%--id="blogType"--%> class="btn btn-success">
                           <c:forEach items="${types}" var="types">
                       <option value="${types.blogType}" id="blogType">${types.blogType}</option>
                           </c:forEach>
                    </select>
