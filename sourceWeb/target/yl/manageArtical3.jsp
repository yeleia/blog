...
<div class="search-bar col-lg-8 col-lg-offset-2">
    <form action="${pageContext.request.contextPath}/Agl" method="post">
...
<div class="content col-lg-10 col-lg-offset-1">
    ...
    <div class="sort">
        <form action="${pageContext.request.contextPath}/exportPaper" method="post" id="exportForm">
            <span>排序：</span>
            <div class="btn-group" role="group" aria-label="...">
                <a href="${pageContext.request.contextPath}/Agl?type=1"> <button type="button" class="btn btn-default ">论文标题</button></a>
                <a href="${pageContext.request.contextPath}/Agl?type=2"> <button type="button" class="btn btn-default ">发表时间</button></a>
                <a href="${pageContext.request.contextPath}/Agl?type=3"> <button type="button" class="btn btn-default active">积分</button></a>
    ...
    <table class="table table-responsive">
        ...
        <c:forEach var="papers" items="${papers}">
            <tr>
                ...
                <td>
                    <input type="checkbox" name="checkbox" class="select" value="${papers.id}">
                </td>
                </td>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/downA?id=${papers.id}"> <button class="btn btn-success" title="下载">
                        <span class="glyphicon glyphicon-download-alt"></span>
                    </button>
                    </a>

                    <a href="${pageContext.request.contextPath}/deleteA?id=${papers.id}"> <button class="btn btn-danger" title="删除">
