...
<div class="content col-lg-10 col-lg-offset-1">
    <h1>个人信息</h1>
    <div id="info">
        <form action="${pageContext.request.contextPath}/updateNikeName?id=${admin.id}" method="post" >
            <label>昵称：</label>
            <input type="text" name="nikeName" class="form-control" value="${admin.nikeName}">
            <br>
            <label>修改密码：</label>
            ...
            <div class="modal fade" id="changePassword" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="${pageContext.request.contextPath}/updatePassword?id=${admin.id}" id="checkPassword">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" onclick="check()">确认修改</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script src="${pageContext.request.contextPath}/static/js/check-password.js"></script>
</body>
</html>
