    ...
    <div class="sort">
        <form action="${pageContext.request.contextPath}/exportUser" method="post" id="exportForm">
            ...
            <div class="btn-group" role="group" aria-label="...">
                ...
                <a href="${pageContext.request.contextPath}/userGl?type=2"><button type="button" class="btn btn-default ">上传论文数</button></a>
                <a href="${pageContext.request.contextPath}/userGl?type=3"><button type="button" class="btn btn-default active">课题项目数</button></a>
