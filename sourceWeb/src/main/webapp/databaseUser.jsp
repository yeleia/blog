    ...
    <div class="doc">
        ...
        <table class="table table-responsive">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/adminDelectP?id=${papers.id}"><button class="btn btn-danger btn-sm" title="删除"><span class="glyphicon glyphicon-trash"></span></button></a>
        ...
        <table class="table table-responsive">
            ...
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/seeProject?id=${projects.id}"><button class="btn btn-info btn-sm" title="查看">
               ...
               <%--   <button class="btn btn-info btn-sm" title="修改" data-toggle="modal" data-target="#change">
                   ...
                   <a href="${pageContext.request.contextPath}/AdeleteProject?id=${projects.id}"> <button class="btn btn-danger btn-sm" title="删除">
...
<div class="modal fade" id="change" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="${pageContext.request.contextPath}/upSource" method="post" enctype="multipart/form-data">
