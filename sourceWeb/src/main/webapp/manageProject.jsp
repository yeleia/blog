...
<div class="content col-lg-10 col-lg-offset-1">
    <div class="sort">
        <form action="${pageContext.request.contextPath}/exportProject" method="post" id="exportForm">
            ...
            <div class="btn-group" role="group" aria-label="...">
                <a href="${pageContext.request.contextPath}/projectgl?type=1"><button type="button" class="btn btn-default active">用户名</button></a>
                ...
                <a href="${pageContext.request.contextPath}/projectgl?type=4"><button type="button" class="btn btn-default">级别分值</button></a>
    ...
    <table class="table table-responsive">
        ...
        <tr>
            ...
            <td>
                <a href="${pageContext.request.contextPath}/seeProject?id=${projects.id}">
                    <button class="btn btn-info" title="查看详情">
