    ...
    <div class="sort">
        <form action="${pageContext.request.contextPath}/exportPaper" method="post" id="exportForm">
            ...
            <div class="btn-group" role="group" aria-label="...">
                ...
                <a href="${pageContext.request.contextPath}/Agl?type=2"> <button type="button" class="btn btn-default active">发表时间</button></a>
                <a href="${pageContext.request.contextPath}/Agl?type=3"> <button type="button" class="btn btn-default">积分</button></a>
